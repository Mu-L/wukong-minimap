...
pub fn get_icons() -> Vec<IconCheckbox> {
    let icons: Vec<IconCheckbox> = vec![
        ...
        IconCheckbox::new("xiandan", "仙丹", true),
        IconCheckbox::new("yongpin", "用品", true),
        IconCheckbox::new("yaopin", "药品", true),
        IconCheckbox::new("cailiao", "材料", true),
        IconCheckbox::new("jingpo", "精魄", true),
        IconCheckbox::new("yaocai", "药材", true),
        IconCheckbox::new("luojia", "落伽香藤", true),
        IconCheckbox::new("sandongchong", "三冬虫", true),
        IconCheckbox::new("lingyun", "灵蕴", true),
    ];
    icons
}
